...
def templateGen():
  ...
  return render_template("templateGen.html", noTrabajo=session["noWorks"], noContacto= session["noContact"], noPrograma=session["noProgram"], noIdioma=session["noLanguage"], noEducacion=session["noEducation"])
